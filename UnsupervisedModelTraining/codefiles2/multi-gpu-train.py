...
parser.add_argument('--init_lr', type=float, default=5*10**-5, # value from paper
...
if args.restore_path is not None:
    ...
    weights_list = np.load(args.restore_path + '/model.npy', allow_pickle=True)
